    ...
    <AppShell>
      ...
      <section className="hero-card">
        <div>
          ...
          <h2 className="hero-title">Dashboard សាលា ទំនើប និងគ្រប់គ្រងប្រាក់សិក្សា</h2>
          <p className="hero-text">មើលស្ថិតិសិស្ស ប្រូហ្វាល់គ្រូ និងចំណូលសរុបជាប្រព័ន្ធតែមួយ។</p>
        </div>
